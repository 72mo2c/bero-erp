...
// مكون wrapper لمسار تسجيل دخول المؤسسة
const OrgLoginWrapper = () => {
  const { orgId } = useParams();
...
// مكون wrapper للمسارات القديمة المحمية
const LegacyRouteWrapper = () => {
  return (
    <AuthProvider>
      <NotificationProvider>
        <DataProvider>
